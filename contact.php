        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="conatct-info">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/phone-icon.png" alt="" decoding="async" loading="lazy">
                        </div>
                        <div class="content">
                    ...
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/mail-icon.png" alt="" decoding="async" loading="lazy">
                        </div>
                        <div class="content">
                    ...
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/map-icon.png" alt="" decoding="async" loading="lazy">
                        </div>
                        <div class="content">
                            <span>Visit Now</span>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="cta-home-box">
                    ...
                    <div class="cta-btn">
                        <a class="main-btn" href="contact">Lat's Get Started</a>
                    </div>
                </div>
            </div>
        </div>
