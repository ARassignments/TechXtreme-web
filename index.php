...
<!-- =======*****************==============*****************==============*****************=======  -->
    ...
    <!--======= TECHEXTREMEE BANNER PART START ======-->
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="infetech-banner-content">
                            ...
                            <div class="info-text">
                                <h1 class="title" data-animation="fadeInLeft" data-delay=".3s">Transforming Visions into Digital Realities</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">Through innovative solutions and creative expertise, we specialize in transforming visions into digital realities that captivate and inspire.</p>
                                <ul class="logos">
                                    <li>
                                        <a href="javascript:;" tabindex="0">
                                            <img src="<?php echo $basesurl;?>images/images/clutch-icon.png" alt="awards-img" decoding="async" loading="lazy">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" tabindex="0">
                                            <img src="<?php echo $basesurl;?>images/images/trustpilot-icon.png" alt="awards-img" decoding="async" loading="lazy">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" tabindex="0">
                                            <img src="<?php echo $basesurl;?>images/images/goodFirms-icon.png" alt="awards-img" decoding="async" loading="lazy">
                                        </a>
                                    </li>
                                </ul>
                                <a class="main-btn" data-animation="fadeInUp" data-delay=".9s" href="<?php echo $path;?>about">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="infetech-banner-content">
                            ...
                            <div class="info-text">
                                <h1 class="title" data-animation="fadeInLeft" data-delay=".3s">Seamless IT and Creative Video Solutions</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">Our fusion of seamless IT infrastructure and creative video solutions ensures a harmonious blend of technology and artistry for your projects.</p>
                                <ul class="logos">
                                    <li>
                                        <a href="javascript:;" tabindex="0">
                                            <img src="<?php echo $basesurl;?>images/images/clutch-icon.png" alt="awards-img" decoding="async" loading="lazy">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="infetech-banner-content">
                            ...
                            <div class="info-text">
                                <h1 class="title" data-animation="fadeInLeft" data-delay=".3s">Elevate Your Digital Presence with Our Services</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">Elevate your digital presence with our services and embark on a journey to stand out, engage, and succeed in the digital landscape.</p>
                                <ul class="logos">
                                    <li>
                                        <a href="javascript:;" tabindex="0">
                                            <img src="<?php echo $basesurl;?>images/images/clutch-icon.png" alt="awards-img" decoding="async" loading="lazy">
    ...
    <!--======= TECHEXTREMEE BANNER PART ENDS ======-->
 <!--======= TECHEXTREMEE SPONSER PART ENDS ======-->
        ...
        <div class="row infetech-sponser-slide">
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-1.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-8.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-2.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-3.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-4.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-5.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-6.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl;?>images/images/cl-7.svg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<!--======= TECHEXTREMEE SPONSER PART ENDS ======-->
    <!--======= TECHEXTREMEE ABOUT PART ENDS ======-->

    <section class="infetech-about-3-area">
        <div class="container">
            <div class="row ">
                <div class="col-lg-6">
                    <div class="about-3-thumb  wow fadeInLeft animated" data-wow-duration="1500ms" data-wow-delay="0ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInLeft;">
                        <img class="about-ring" src="<?php echo $basesurl;?>images/about-thumb-ring.png" alt="">
                        <img class="about-thumb-1" src="<?php echo $basesurl;?>images/about-thumb-3.jpg" alt="">
                        <img class="about-thumb-2" src="<?php echo $basesurl;?>images/about-thumb-4.jpg" alt="">
                        <img class="about-thumb-3" src="<?php echo $basesurl;?>images/about-thumb-5.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-3-content  wow fadeInRight animated" data-wow-duration="1500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInRight;">
                        <div class="section-title">
                            <span>Unveiling Our Identity</span>
                            <h3 class="title">Learn More About Our Company's Mission, and Vision</h3>
                            <p>In our comprehensive about section, delve into the rich tapestry of our company's journey, explore our unwavering commitment to our mission, and envision the future we aspire to create.</p>
                        </div>
                        <div class="about-sub-service mt-40">
                            <div class="icon">
                                <img src="<?php echo $basesurl;?>images/icon/about-icon-1.png" alt="">
                            </div>
                            <div class="content">
                                <h5 class="title">Empowering Businesses Through Innovative Technology Solutions</h5>
                                <p>We are dedicated to delivering cutting-edge IT services that enable our clients to thrive in the digital age, fostering growth and efficiency in their operations.</p>
                            </div>
                        </div>
                        <div class="about-sub-service">
                            <div class="icon">
                                <img src="<?php echo $basesurl;?>images/icon/about-icon-2.png" alt="">
                            </div>
                            <div class="content">
                                <h5 class="title">Bridging Tomorrow's Challenges with Today's Solutions</h5>
                                <p>We envision a future where our technology expertise drives sustainable progress, offering tailor-made solutions to address the evolving needs of businesses in a rapidly changing world.</p>
                            </div>
                        </div>
                        <a class="main-btn" href="<?php echo $path;?>about">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--======= TECHEXTREMEE SERVICE PART ENDS ======-->

    <section class="infetech-service-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-infetech-serice-item animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0ms">
                        <div class="thumb">
                            <img src="<?php echo $basesurl;?>images/images/service-1.jpg" alt="services-images">
                        </div>
                        <div class="content">
                            <div class="icon">
                                <img src="<?php echo $basesurl;?>images/icon/service-icon-1.png" alt="services-images-icon">
                            </div>
                            <h3 class="title"><a href="javascript:;">Perfect solutions that business demands</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-infetech-serice-item animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                        <div class="thumb">
                            <img src="<?php echo $basesurl;?>images/images/service-2.jpg" alt="services-images-icon">
                        </div>
                        <div class="content">
                            <div class="icon">
                                <img src="<?php echo $basesurl;?>images/icon/service-icon-2.png" alt="services-images">
                            </div>
                            <h3 class="title"><a href="javascript:;">Reduced Spending with IT Talent Sourcing</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-infetech-serice-item animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="thumb">
                            <img src="<?php echo $basesurl;?>images/images/service-3.jpg" alt="services-images">
                        </div>
                        <div class="content">
                            <div class="icon">
                                <img src="<?php echo $basesurl;?>images/icon/service-icon-3.png" alt="services-images-icon">
                            </div>
                            <h3 class="title"><a href="javascript:;">Access to Experts and the Latest Technology</a></h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--======= TECHEXTREMEE FEATURE PART ENDS ======-->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="section-title section-title-2">
                        ...
                        <h4 class="title">Comprehensive IT Solutions and Services</h4>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row infetech-feature-slide">
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        ...
                        <div class="content">
                            ...
                            <p>Transform your digital vision into a stunning reality with our Website Development service, where user experience meets cutting-edge design.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        <div class="icon">
                            <svg id="Layer_1_1_" enable-background="new 0 0 64 64" height="60px" viewBox="0 0 64 64" width="60px" xmlns="http://www.w3.org/2000/svg"><path fill="#b882fc" d="m16 32c0 8.822 7.178 16 16 16s16-7.178 16-16-7.178-16-16-16-16 7.178-16 16zm8.485-11.793 1.62 3.24c.097.193.254.351.447.447l3.034 1.517-2.152 3.589h-3.434c-.431 0-.812.275-.949.684l-.772 2.316h-4.279c0-4.953 2.593-9.304 6.485-11.793zm7.515 22.793v3c-4.906 0-9.223-2.541-11.723-6.371l4.543-1.514 3.58 2.685c.365.273.869.266 1.225-.019l4.301-3.441 2.074 2.074v1.805l-3.243.811c-.445.111-.757.511-.757.97zm14-11c0 2.206-.527 4.287-1.44 6.146l-2.273-2.273 1.545-2.318c.156-.234.207-.524.138-.797l-1-4c-.067-.27-.245-.5-.489-.634-.245-.135-.534-.16-.798-.072l-2.316.772-2.282-3.042.696-2.782h4.928c2.05 2.436 3.291 5.574 3.291 9zm-9-11c-.459 0-.859.312-.97.757l-1 4c-.073.292-.01.602.17.843l3 4c.258.344.708.485 1.116.349l1.976-.659.63 2.523-1.754 2.632c-.265.396-.212.925.125 1.262l3.228 3.228c-2.168 3.137-5.582 5.338-9.521 5.905v-2.06l3.243-.811c.445-.11.757-.51.757-.969v-3c0-.265-.105-.52-.293-.707l-3-3c-.36-.361-.934-.393-1.332-.074l-4.395 3.516-3.38-2.535c-.262-.198-.604-.252-.917-.149l-5.387 1.796c-.555-1.201-.941-2.492-1.137-3.847h4.841c.431 0 .812-.275.949-.684l.772-2.316h3.279c.351 0 .677-.184.857-.485l3-5c.144-.239.181-.527.103-.794s-.264-.49-.513-.615l-3.702-1.851-1.501-3.003c1.758-.797 3.703-1.252 5.756-1.252 3.257 0 6.251 1.128 8.632 3z"/><path fill="#b882fc" d="m59 29c-1.302 0-2.402.839-2.816 2h-6.184v2h6.184c.414 1.161 1.514 2 2.816 2 1.654 0 3-1.346 3-3s-1.346-3-3-3zm0 4c-.551 0-1-.449-1-1s.449-1 1-1 1 .449 1 1-.449 1-1 1z"/><path fill="#b882fc" d="m59 49c0-1.654-1.346-3-3-3-1.302 0-2.402.839-2.816 2h-1.507l-1.749-4.372c-.152-.379-.519-.628-.928-.628h-3v2h2.323l1.749 4.372c.152.379.519.628.928.628h2.184c.414 1.161 1.514 2 2.816 2 1.654 0 3-1.346 3-3zm-4 0c0-.551.449-1 1-1s1 .449 1 1-.449 1-1 1-1-.449-1-1z"/><path fill="#b882fc" d="m48 61c1.654 0 3-1.346 3-3s-1.346-3-3-3c-1.302 0-2.402.839-2.816 2h-2.43l-1.793-6.275c-.122-.429-.515-.725-.961-.725h-5v2h4.246l1.793 6.275c.122.429.515.725.961.725h3.184c.414 1.161 1.514 2 2.816 2zm0-4c.551 0 1 .449 1 1s-.449 1-1 1-1-.449-1-1 .449-1 1-1z"/><path fill="#b882fc" d="m39.895 13.447 2.723-5.447h2.554c.421 1.19 1.557 2 2.827 2 .149 0 .3-.011.452-.034.792-.121 1.49-.542 1.965-1.188s.67-1.438.55-2.229c-.249-1.635-1.779-2.759-3.417-2.516-.792.121-1.49.542-1.965 1.188-.177.241-.301.506-.399.779h-3.185c-.379 0-.725.214-.895.553l-2.723 5.447h-3.382v2h4c.379 0 .725-.214.895-.553zm7.299-7.04c.159-.215.391-.356.655-.396.051-.008.101-.011.151-.011.486 0 .914.355.989.85.04.264-.025.528-.183.743-.159.215-.391.356-.655.396-.538.085-1.056-.293-1.139-.839-.041-.264.024-.528.182-.743z"/><path fill="#b882fc" d="m54.184 17c.414 1.161 1.514 2 2.816 2 1.654 0 3-1.346 3-3s-1.346-3-3-3c-1.302 0-2.402.839-2.816 2h-4.184c-.334 0-.646.167-.832.445l-1.703 2.555h-2.465v2h3c.334 0 .646-.167.832-.445l1.703-2.555zm2.816-2c.551 0 1 .449 1 1s-.449 1-1 1-1-.449-1-1 .449-1 1-1z"/><path fill="#b882fc" d="m3 27c-.552 0-1 .448-1 1v8c0 .552.448 1 1 1h2.464c.25 1.328.604 2.646 1.058 3.937l-2.137 1.233c-.479.276-.642.888-.366 1.366l4 6.928c.276.478.885.642 1.366.366l2.141-1.236c.886 1.029 1.85 1.994 2.879 2.879l-1.236 2.141c-.276.479-.112 1.09.366 1.366l6.928 4c.477.275 1.089.111 1.366-.366l1.233-2.137c1.29.454 2.608.808 3.937 1.058v2.465c0 .552.448 1 1 1h4c.552 0 1-.448 1-1v-10c0-.552-.448-1-1-1-9.925 0-18-8.075-18-18s8.075-18 18-18c.552 0 1-.448 1-1v-10c0-.552-.448-1-1-1h-4c-.552 0-1 .448-1 1v2.464c-1.328.25-2.646.604-3.937 1.058l-1.232-2.137c-.277-.479-.889-.643-1.366-.366l-6.928 4c-.479.276-.642.888-.366 1.366l1.236 2.141c-1.029.886-1.994 1.85-2.879 2.879l-2.142-1.235c-.481-.276-1.09-.112-1.366.366l-4 6.928c-.276.478-.112 1.09.366 1.366l2.137 1.233c-.454 1.291-.808 2.609-1.058 3.937zm4.295 1.153c.271-1.75.738-3.491 1.39-5.172.178-.46-.005-.981-.433-1.228l-2-1.155 3-5.196 2.004 1.157c.427.246.969.144 1.278-.238 1.122-1.391 2.396-2.665 3.787-3.787.383-.309.484-.852.238-1.278l-1.157-2.004 5.196-3 1.155 2c.247.427.767.609 1.227.433 1.682-.652 3.422-1.119 5.172-1.39.488-.075.848-.495.848-.988v-2.307h2v8.025c-10.565.522-19 9.282-19 19.975s8.435 19.453 19 19.975v8.025h-2v-2.307c0-.493-.36-.913-.847-.988-1.75-.271-3.491-.738-5.172-1.39-.46-.177-.98.005-1.228.433l-1.155 2-5.196-3 1.157-2.004c.246-.427.145-.969-.238-1.278-1.391-1.122-2.665-2.396-3.787-3.787-.31-.384-.852-.485-1.278-.238l-2.004 1.157-3-5.196 2-1.155c.427-.247.611-.768.433-1.227-.652-1.682-1.119-3.422-1.39-5.172-.075-.488-.495-.848-.988-.848h-2.307v-6h2.307c.493 0 .913-.36.988-.847z"/></svg>
                        </div>
                        <div class="content">
                            <h4 class="title"><a href="#">Search Engine <br>Optimization</a></h4>
                            <p>Unlock the full potential of your online presence with our SEO service and watch your website climb to the top of search engine results.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        <div class="icon">
                            <svg fill="#b882fc" id="Layer_5" enable-background="new 0 0 62 62" height="60px" viewBox="0 0 62 62" width="60px" xmlns="http://www.w3.org/2000/svg"><g><path d="m4 4h2v4h-2z"/><path d="m8 4h2v4h-2z"/><path d="m4 24h2v4h-2z"/><path d="m8 24h2v4h-2z"/><path d="m14 14h2v4h-2z"/><path d="m18 14h2v4h-2z"/><path d="m10 48h6v2h-6z"/><path d="m10 52h6v2h-6z"/><path d="m10 56h6v2h-6z"/><path d="m28 48h6v2h-6z"/><path d="m28 52h6v2h-6z"/><path d="m28 56h6v2h-6z"/><path d="m46 52h6v2h-6z"/><path d="m46 56h6v2h-6z"/><path d="m52.364 9.537-.18-.612-.631-.095c-2.525-.378-6.232-.83-9.553-.83s-7.028.452-9.553.831l-.631.095-.18.612c-.752 2.557-2.589 4.639-5.038 5.712l-.598.261v.925c0 11.263 5.326 22.091 14.247 28.967.5.385 1.123.597 1.753.597s1.252-.212 1.753-.597c8.921-6.876 14.247-17.704 14.247-28.966v-.925l-.599-.262c-2.448-1.074-4.285-3.156-5.037-5.713zm-9.831 34.281c-.302.231-.764.233-1.066 0-8.337-6.426-13.353-16.505-13.465-27.022 2.497-1.277 4.405-3.443 5.352-6.078 2.42-.346 5.704-.718 8.646-.718s6.226.372 8.646.719c.946 2.634 2.854 4.801 5.352 6.078-.112 10.516-5.128 20.596-13.465 27.021z"/><path d="m62 12h-1c-2.757 0-5-2.243-5-5 0-.177.01-.352.028-.524l.095-.91-.898-.175c-.291-.057-7.198-1.391-13.225-1.391s-12.934 1.334-13.225 1.391l-.898.175.095.91c.018.172.028.347.028.524 0 1.852-1.025 3.454-2.525 4.318-.077-.114-.158-.223-.25-.324.476-.531.775-1.226.775-1.994v-6c0-1.654-1.346-3-3-3h-20c-1.654 0-3 1.346-3 3v6c0 .771.301 1.468.78 2-.479.532-.78 1.229-.78 2v6c0 .771.301 1.468.78 2-.479.532-.78 1.229-.78 2v6c0 1.654 1.346 3 3 3h9v12h-6v18h14v-8h4v8h14v-8h4v8h14v-18h-4.823c6.862-7.441 10.823-17.339 10.823-27.563zm-60 7v-6c0-.551.449-1 1-1h19v4.437c0 1.194.071 2.381.177 3.563h-19.177c-.551 0-1-.449-1-1zm0-16c0-.551.449-1 1-1h20c.551 0 1 .449 1 1v6c0 .551-.449 1-1 1h-20c-.551 0-1-.449-1-1zm0 26v-6c0-.551.449-1 1-1h19.407c.33 2.345.865 4.649 1.593 6.889v.111c0 .551-.449 1-1 1h-20c-.551 0-1-.449-1-1zm16 31h-10v-14h10zm2-8v-8h-6v-12h9c.713 0 1.361-.261 1.876-.678 1.846 4.659 4.532 8.975 7.947 12.678h-8.823v8zm6 8v-14h8.814c.391.369.78.74 1.186 1.093v12.907zm12-8v-3.303c1.162.834 2.569 1.303 4 1.303v2zm16 8h-10v-10.315c.715-.218 1.39-.551 2-.989v1.304h6v-2h-5.108c.792-.639 1.557-1.306 2.294-2h4.814zm6-43.563c0 11.878-5.617 23.299-15.026 30.551-1.695 1.307-4.252 1.307-5.947 0-9.41-7.253-15.027-18.673-15.027-30.551v-2.508c3.323-.478 5.9-3.298 5.997-6.728 2.028-.354 7.367-1.201 12.003-1.201s9.975.847 12.003 1.201c.097 3.43 2.674 6.25 5.997 6.728z"/><path d="m37 31.586-2.293-2.293-1.414 1.414 3.707 3.707 15.707-15.707-1.414-1.414z"/></g></svg>
                        </div>
                        <div class="content">
                            <h4 class="title"><a href="#">Video<br>Animation</a></h4>
                            <p>Turn your ideas into captivating visual stories with our Video Animation Service, where creativity meets innovation.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="single-infetech-feature-item">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="#">Content <br> Writing</a></h4>
                            <p>Unlock the power of persuasive words with our Content Writing Service, and let your brand's story shine like never before.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="infetech-project-offer-area-2 pt-120 pb-120">
        ...
        <div class="row align-items-center mb-50">
                <div class="col-lg-8">
                    <div class="section-title">
                        <span>Explore Our Diverse Range of Projects</span>
                        <h4 class="title">Our Portfolio: Transforming Visions into Reality</h4>
                        <p>In the projects section, we invite you to journey through our portfolio, where innovation, creativity, and expertise come together to bring exceptional ideas to life.</p>
                    </div>
                </div>
                <div class="col-lg-4 m-auto float-right">
                    <div class="section-title pl-100">
                        <a class="main-btn" href="<?php echo $path;?>portfolio">View More</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-project-item-2  wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="0ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                        ...
                        <div class="project-content">
                            <div class="text">
                                <a href="#">Unlock Your Imagination:<br> Explore Our Captivating<br> Illustrations!</a>
                            </div>
                            <!-- <div class="icon">
                ...
                <div class="col-lg-6">
                    <div class="single-project-item-2  wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInUp;">
                        <div class="thumb">
                            <img src="<?php echo $basesurl;?>images/images/proj-1.gif" alt="website-portfolio">
                        </div>
                        <div class="project-content">
                            <div class="text">
                                <a href="#">Dive into Our<br> Dynamic Business Website<br> Solutions!</a>
                            </div>
                            <!-- <div class="icon">
                                <a href="#"><i class="fal fa-long-arrow-right"></i></a>
                            </div> -->
    ...
    <!--======= TECHEXTREMEE Project PART ENDS ======-->
    <?php
 ...
 <section class="infetech-blog-area pt-115 pb-120">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="thumb">
                            <a href="#"><img src="<?php echo $basesurl;?>images/blog-1.jpg" alt=""></a>
                            <span>18 mar</span>
                        </div>
                        <div class="content">
                            <div class="blog-meta">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="thumb">
                            <a href="#"><img src="<?php echo $basesurl;?>images/blog-2.jpg" alt=""></a>
                            <span>18 mar</span>
                        </div>
                        <div class="content">
                            <div class="blog-meta">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <div class="thumb">
                            <a href="#"><img src="<?php echo $basesurl;?>images/blog-3.jpg" alt=""></a>
                            <span>18 mar</span>
                        </div>
                        <div class="content">
                            <div class="blog-meta">
                                ...
                                <h4 class="title"><a href="#">Contrary to popular belief, Lorem Ipsum dolor sit from 45 BC.</a></h4>
                                <a href="#">Read More</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="infetech-video-area">
                ...
                <div class="col-lg-5">
                    <div class="video-content-wrapper animated wow fadeIn" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="video-content-box">
                            <div class="item">
                                <!-- <h4 class="title">Efficient IT solutions boost productivity, savings.</h4> -->
                                <span><b>Efficient IT solutions<br>boost productivity,<br> savings.</b></span>
                            </div>
                        </div>
                        <div class="video-content-box item-2 animated wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="item">
                                <!-- <h4 class="title">IT experts cut costs, enhance efficiency.</h4> -->
                                <span><b>IT experts cut costs,<br> enhance efficiency.</b></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="video-shape">
            <img src="<?php echo $basesurl;?>images/video-shape.png" alt="">
        </div>
    </section>

    <!--======= TECHEXTREMEE VIDEO PART ENDS ======-->

    <!--======= TECHEXTREMEE BLOG PART ENDS ======-->
