<!--======= TECHEXTREMEE CTA PART start ======-->
<section class="infetech-technology-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="technology-box  wow fadeIn animated" data-wow-duration="2000ms" data-wow-delay="0ms" style="visibility: visible; animation-duration: 2000ms; animation-delay: 0ms; animation-name: fadeIn;">
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="section-title">
                                    <span>Why Choose Us?</span>
                                    <h3 class="title">Elevate Your Experience with Our Professional Services</h3>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="technology-service">
                                            <div class="icon">
                                                <svg height="24px" width="24px" fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                <g>
                                                    <g>
                                                        <g>
                                            ...
                                            <div class="content">
                                            <h4 class="title">High Ethical Standards</h4>
                                                <p>Conduct and deliverables</p>
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="technology-service">
                                            <div class="icon">
                                                <svg height="24px" width="24px" fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999;" xml:space="preserve">
                                                <g>
                                                    <g>
                                            ...
                                            <div class="content">
                                            <h4 class="title">Seasoned Expertise</h4>
