                ...
                <div class="col-lg-7">
                    <div class="infetech-banner-content">
                        ...
                        <div class="info-text">
                            ...
                            <a class="main-btn" data-animation="fadeInUp" data-delay=".9s" href="about">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row infetech-sponser-slide">
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-1.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-8.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-2.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-3.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-4.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-5.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-6.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="infetech-sponser-item">
                    <img src="<?php echo $basesurl; ?>images/images/cl-7.svg" decoding="async" loading="lazy" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row ">
            <div class="col-lg-6">
                <div class="about-3-thumb  wow fadeInLeft animated" data-wow-duration="1500ms" data-wow-delay="0ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInLeft;">
                    <img class="about-ring" src="<?php echo $basesurl; ?>images/about-thumb-ring.png" alt="" decoding="async" loading="lazy">
                    <img class="about-thumb-1" src="<?php echo $basesurl; ?>images/about-thumb-3.jpg" alt="" decoding="async" loading="lazy">
                    <img class="about-thumb-2" src="<?php echo $basesurl; ?>images/about-thumb-4.jpg" alt="" decoding="async" loading="lazy">
                    <img class="about-thumb-3" src="<?php echo $basesurl; ?>images/about-thumb-5.jpg" alt="" decoding="async" loading="lazy">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-3-content  wow fadeInRight animated" data-wow-duration="1500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInRight;">
                    ...
                    <div class="about-sub-service mt-40">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/about-icon-1.png" alt="" decoding="async" loading="lazy">
                        </div>
                        <div class="content">
                    ...
                    <div class="about-sub-service">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/about-icon-2.png" alt="" decoding="async" loading="lazy">
                        </div>
                        <div class="content">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-infetech-serice-item animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0ms">
                    <div class="thumb">
                        <img src="<?php echo $basesurl; ?>images/images/service-1.jpg" alt="services-images" decoding="async" loading="lazy">
                    </div>
                    <div class="content">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/service-icon-1.png" alt="services-images-icon" decoding="async" loading="lazy">
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-infetech-serice-item animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="thumb">
                        <img src="<?php echo $basesurl; ?>images/images/service-2.jpg" alt="services-images-icon" decoding="async" loading="lazy">
                    </div>
                    <div class="content">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/service-icon-2.png" alt="services-images" decoding="async" loading="lazy">
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-infetech-serice-item animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="thumb">
                        <img src="<?php echo $basesurl; ?>images/images/service-3.jpg" alt="services-images" decoding="async" loading="lazy">
                    </div>
                    <div class="content">
                        <div class="icon">
                            <img src="<?php echo $basesurl; ?>images/icon/service-icon-3.png" alt="services-images-icon" decoding="async" loading="lazy">
                        </div>
    ...
    <div class="container">
        <div class="row align-items-center mb-50">
            ...
            <div class="col-lg-4 m-auto float-right">
                <div class="section-title pl-100">
                    <a class="main-btn" href="portfolio">View More</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="single-project-item-2  wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInUp;">
                    <div class="thumb">
                        <img src="<?php echo $basesurl; ?>images/images/proj-1.gif" alt="website-portfolio" decoding="async" loading="lazy">
                    </div>
                    <div class="project-content">
                        <div class="text">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="banner-content-box">
                    ...
                    <div class="thumb">
                        <img src="<?php echo $basesurl; ?>images/images/techxtremee-story.gif" alt="company-image" decoding="async" loading="lazy">
                        ...
                        <div class="icon">
                            <svg id="light" enable-background="new 0 0 24 24" fill="#fff" height="55px" viewBox="0 0 24 24" width="55px" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                ...
                                <g>
                                    <path d="m14.5 21h-5c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h5c.3 0 .5.2.5.5s-.2.5-.5.5z"></path>
                                </g>
                                <g>
                                    <path d="m12 3c-.3 0-.5-.2-.5-.5v-2c0-.3.2-.5.5-.5s.5.2.5.5v2c0 .3-.2.5-.5.5z"></path>
                                </g>
                                <g>
                                    <path d="m18.7 5.8c-.1 0-.3 0-.4-.1-.2-.2-.2-.5 0-.7l1.4-1.4c.2-.2.5-.2.7 0s.2.5 0 .7l-1.4 1.4s-.2.1-.3.1z"></path>
                                </g>
                                <g>
                                    <path d="m23.5 12.5h-2c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5z"></path>
                                </g>
                                <g>
                                    <path d="m20.1 20.6c-.1 0-.3 0-.4-.1l-1.4-1.4c-.2-.2-.2-.5 0-.7s.5-.2.7 0l1.4 1.4c.2.2.2.5 0 .7 0 .1-.1.1-.3.1z"></path>
                                </g>
                                <g>
                                    <path d="m3.9 20.6c-.1 0-.3 0-.4-.1-.2-.2-.2-.5 0-.7l1.4-1.4c.2-.2.5-.2.7 0s.2.5 0 .7l-1.4 1.4c-.1.1-.2.1-.3.1z"></path>
                                </g>
                                <g>
                                    <path d="m2.5 12.5h-2c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5z"></path>
                                </g>
                                <g>
                                    <path d="m5.3 5.8c-.1 0-.3 0-.4-.1l-1.4-1.5c-.2-.2-.2-.5 0-.7s.5-.2.7 0l1.4 1.4c.2.2.2.5 0 .7-.1.1-.2.2-.3.2z"></path>
                                </g>
                                <g>
                                    <path d="m16 12.5c-.3 0-.5-.2-.5-.5 0-1.9-1.6-3.5-3.5-3.5-.3 0-.5-.2-.5-.5s.2-.5.5-.5c2.5 0 4.5 2 4.5 4.5 0 .3-.2.5-.5.5z"></path>
                                </g>
                            </svg>
                        </div>
                        <div class="icon icon-2">
                            <svg id="Layer_1" fill="#fff" height="55px" viewBox="0 0 512 512" width="55px" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
                                <path d="m409.632 334.726a12 12 0 0 0 -16.971 0l-7.175 7.175-37.5-37.5a192.723 192.723 0 0 0 20.214-189.101l55.155-66.5v27.963a12 12 0 1 0 24 0v-61.229a12 12 0 0 0 -12-12h-61.233a12 12 0 0 0 0 24h35.685l-53.617 64.65a191.815 191.815 0 0 0 -28.244-35.917c-74.9-74.9-196.777-74.9-271.679 0s-74.9 196.777 0 271.679a192.409 192.409 0 0 0 248.133 20.037l37.5 37.5-7.176 7.175a12 12 0 0 0 0 16.971l86.9 86.9a53.03 53.03 0 0 0 74.907 0l-8.485-8.486 8.485 8.485a53.085 53.085 0 0 0 0-74.905zm-336.395-261.489a168.119 168.119 0 0 1 266.608 38.654l-43.923 52.961-127.8-68.1a12 12 0 0 0 -14.394 2.379l-124.843 133.042a168.174 168.174 0 0 1 44.352-158.936zm0 237.739a167.2 167.2 0 0 1 -35.745-52.9l127.449-135.822 128.329 68.379a12 12 0 0 0 14.88-2.929l42.55-51.304a168.319 168.319 0 0 1 -39.724 174.578c-65.545 65.543-172.194 65.543-237.739-.002zm249.793 21.7c1.657-1.545 3.3-3.112 4.916-4.727s3.182-3.259 4.728-4.917l35.841 35.842-9.644 9.644zm115.57 146.889-78.419-78.419 40.965-40.964 78.42 78.419a28.967 28.967 0 0 1 -40.966 40.964z"></path>
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                    <div class="thumb">
                        <a href="#"><img src="<?php echo $basesurl; ?>images/blog-1.jpg" alt="" decoding="async" loading="lazy"></a>
                        <span>18 mar</span>
                    </div>
                    <div class="content">
                        <div class="blog-meta">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                    <div class="thumb">
                        <a href="#"><img src="<?php echo $basesurl; ?>images/blog-2.jpg" alt="" decoding="async" loading="lazy"></a>
                        <span>18 mar</span>
                    </div>
                    <div class="content">
                        <div class="blog-meta">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                    <div class="thumb">
                        <a href="#"><img src="<?php echo $basesurl; ?>images/blog-3.jpg" alt="" decoding="async" loading="lazy"></a>
                        <span>18 mar</span>
                    </div>
                    <div class="content">
                        <div class="blog-meta">
...
<section class="infetech-video-area">
    ...
    <div class="video-shape">
        <img src="<?php echo $basesurl; ?>images/video-shape.png" alt="" decoding="async" loading="lazy">
    </div>
</section>
